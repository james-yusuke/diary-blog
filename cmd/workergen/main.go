...
func generate(root string) error {
	...
	if err := writeAssets(filepath.Join(root, "internal", "site", "assets_tinygo_gen.go"), string(css), string(mermaidJS)); err != nil {
		return err
	}
	return nil
}
...
func writeAssets(path, css, mermaidJS string) error {
