...
func generate(root string) error {
	...
	adsTXT, err := os.ReadFile(filepath.Join(root, "internal", "site", "ads.txt"))
	if err != nil {
		return err
	}
	if err := writeAssets(filepath.Join(root, "internal", "site", "assets_tinygo_gen.go"), string(css), string(tokensCSS), string(mermaidJS), string(siteJS), string(adsTXT)); err != nil {
		return err
	}
	return nil
}
